...
DB_dir_test = pathlib.Path(r"/home/carlos/Desktop/Decimo/Titulacion_II/Algorithms/FP_Cells/DB_3/test") # get data base path
...
image_count_test = len(list(DB_dir_test.glob("*/*g"))) # get dataset size

print("\nTraining Images Data Base Size: ", image_count_train, "\n")
print("Validation Images Data Base Size: ", image_count_val, "\n")
print("Validation Images Data Base Size: ", image_count_test, "\n")
...
test = datagen.flow_from_directory(DB_dir_test, target_size=(img_height, img_width), shuffle=False, batch_size=batch_size, class_mode='sparse')# Get the images of the validation folder
print("\n")
...
model.save("FP_Cells_new"+str(round(val_accuracy, 3))+"_epo_" + str(e)) #save model

show_history(history)
plot_history(history, path="/home/carlos/Desktop/Decimo/Titulacion_II/Algorithms/FP_Cells/accurancy_loss1.png")
plt.close()
